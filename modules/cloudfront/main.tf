...
resource "aws_cloudfront_distribution" "this" {
  ...
  dynamic "origin" {
    ...
    content {
      ...
      dynamic "custom_origin_config" {
        ...
        content {
          http_port                = lookup(custom_origin_config.value.http_port, "http_port", 80)
          https_port               = lookup(custom_origin_config.value.https_port, "https_port", 443)
          origin_protocol_policy   = lookup(custom_origin_config.value.origin_protocol_policy, "origin_protocol_policy", "https-only")
          origin_ssl_protocols     = lookup(custom_origin_config.value.origin_ssl_protocols, "origin_ssl_protocols", "TLSv1.1")
  ...
  dynamic "default_cache_behavior" {
    ...
    content {
      ...
      allowed_methods           = lookup(i.value, "allowed_methods", ["GET", "HEAD"])
      cached_methods            = lookup(i.value, "cached_methods", ["GET", "HEAD"])
      compress                  = lookup(i.value, "compress", true)
      field_level_encryption_id = lookup(i.value, "field_level_encryption_id", null)
      smooth_streaming          = lookup(i.value, "smooth_streaming", false)
